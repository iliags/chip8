                ...
                0xF000 => {
                    match opcode & 0x00FF {
                        ...
                        0x0000 => {
                            ...
                            let address =
                                (memory.data[pc] as u16) << 8 | (memory.data[pc + 1] as u16);
                        ...
                        // 0xFX01
                        0x0001 => display.set_active_plane(reg_x),
                        ...
                        0x0030 => {
                            ...
                            let font_size =
                                &FONT_DATA[memory.system_font as usize].small_data.len();
